...
<body>
    <div class="wrap">
        ...
        <aside id="keyboard" class="flex flex-col w-full border-t border-base-300 bg-neutral">
            <div id="progress" class="flex w-full p-2">
                <div data-step-guide="0" class="flex-none border border-success h-4">
                    &nbsp;
                </div>

                <div data-step-guide="1" class="flex-none border border-success h-4">
                    &nbsp;
                </div>

                <div data-step-guide="2" class="flex-none border border-success h-4">
                    &nbsp;
                </div>

                <div data-step-guide="3" class="flex-none border border-success h-4">
                    &nbsp;
                </div>

                <div data-step-guide="4" class="flex-none border border-success h-4">
                    &nbsp;
                </div>

                <div data-step-guide="5" class="flex-none border border-success h-4">
                    &nbsp;
                </div>
            </div>
            ...
            <div id="controls" class="flex justify-between items-center px-5 m-2 w-full">
                ...
                <div id="control" class="p-1 border rounded-full">
                    <div class="btn btn-sm">
                        <svg id="playIcon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M5.25 5.653c0-.856.917-1.398 1.667-.986l11.54 6.348a1.125 1.125 0 010 1.971l-11.54 6.347a1.125 1.125 0 01-1.667-.985V5.653z" /></svg>
                    </div>
                </div>
            ...
            <div id="input" class="mt-2 p-2 w-full">
                ...
                <input
                    id="answer"
                    class="input input-bordered w-full autocomplete-input"
                    type="text"
